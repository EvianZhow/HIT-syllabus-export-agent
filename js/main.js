function jwc_parse(doc, semester_begin_time, csv_content) {
...
function parse() {
  ...
  if (document.URL == "http://clop.hit.edu.cn/listBookingInfos.action") {
    clop_parse(document, d.getTime(), "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description,Location,Private\n");
  } else if (document.URL == "http://jwts.hit.edu.cn/kbcx/queryGrkb") {
    jwc_parse(document, d.getTime(), "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description,Location,Private\n");
  };
}
...
if (document.URL == "http://jwts.hit.edu.cn/kbcx/queryGrkb") {
